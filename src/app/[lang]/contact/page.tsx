  ...
  return (
    <div className="section-padding">
      <div className="container-page">
        <Breadcrumb items={[{ label: lang === "zh" ? "首页" : "Home", href: `/${lang}` }, { label: lang === "zh" ? "联系我们" : "Contact" }]} className="mb-6" />
        ...
        <div className="mt-12 grid md:grid-cols-[1fr_400px] gap-10">
          ...
          <div className="bg-white border border-neutral-200 rounded-lg p-8 shadow-sm reveal-on-scroll">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <Checkbox checked={agreed} onChange={e => { setAgreed(e.target.checked); setAgreeError(false); }} label={<span>{lang === "zh" ? "我已阅读并同意" : "I agree to the"} <Link href={`/${lang}/about`} className="text-primary-500 underline">{lang === "zh" ? "《隐私政策》" : "Privacy Policy"}</Link></span>} error={agreeError ? (lang === "zh" ? "请阅读并同意隐私政策" : "Please agree") : undefined} />
              </div>
          ...
          <div className="space-y-6 reveal-on-scroll">
            <div className="bg-white border border-neutral-200 rounded-lg p-6 shadow-sm">
              ...
              <ul className="space-y-4">
                {[
                  { icon: <svg className="size-5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M9.69 18.933l.003.001C9.89 19.02 10 19 10 19s.11.02.308-.066l.002-.001.006-.003.018-.008a5.741 5.741 0 00.281-.14c.186-.096.446-.24.757-.433.62-.384 1.445-.966 2.274-1.765C15.302 15.088 17 12.61 17 9A7 7 0 103 9c0 3.61 1.698 6.088 3.355 7.584a13.731 13.731 0 002.273 1.765 11.842 11.842 0 00.976.544l.062.029.018.008.006.003zM10 11.25a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5z" clipRule="evenodd" /></svg>, label: lang === "zh" ? "北京市朝阳区建国路88号SOHO现代城A座" : "A SOHO Modern Town, 88 Jianguo Rd, Beijing" },
                  ...
                  { icon: <svg className="size-5" viewBox="0 0 20 20" fill="currentColor"><path d="M3 4a2 2 0 00-2 2v1.161l8.441 4.221a1.25 1.25 0 001.118 0L19 7.162V6a2 2 0 00-2-2H3z" /><path d="M19 8.839l-7.77 3.885a2.75 2.75 0 01-2.46 0L1 8.839V14a2 2 0 002 2h14a2 2 0 002-2V8.839z" /></svg>, label: "contact@renzheng.com" },
                ].map((item, i) => (
