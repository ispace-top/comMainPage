...
function initSchema() {
  ...
  if (contentCount.count === 0) {
    ...
    const seedContent: [string, string, string, string, string, string, string, string][] = [
      ...
      ["services", "CCC 中国强制性产品认证", "published", "CCC认证", "", "CCC 认证是中国强制性产品认证制度，是产品进入中国市场的安全通行证，覆盖电子电器、汽车零部件、玩具、建材等16大类产品。", "CCC 认证（China Compulsory Certification）由国家认监委监管。正远智汇提供从产品测试、工厂审查到获证维护的全流程 CCC 认证咨询服务，帮助企业高效、合规地取得 CCC 证书，顺利进入中国市场。", "2026-05-10"],
